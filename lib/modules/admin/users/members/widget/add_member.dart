    ...
    Get.bottomSheet(
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text('Add New Member', style: AppTextStyles.h3),
              IconButton(
          ...
          Container(
            ...
            child: QrImageView(
              data: controller.joinMemberQrCode.value,
          ...
          Text(
            'Ask user to scan this QR to join gym',
          ...
          Column(
            ...
            children: [
              Text('Select Membership Plan', style: AppTextStyles.caption),
              const SizedBox(height: 8),
              Obx(() => Container(
      decoration: BoxDecoration(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          value: controller.selectedMembershipPlan.value,
          isExpanded: true,
          ...
          onChanged: (val) {
            if (val != null) {
              controller.selectedMembershipPlan.value = val;
            }
          },
        ),
      ),
