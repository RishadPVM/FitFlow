...
Widget trainersListView(TrainersController controller) {
                  ...
                  Row(
                    children: [
                      _buildCircleAction(
                        ...
                        color: AppColors.primaryBlue,
                        onTap: () => _showEditTrainerUI(Get.context!, trainer , controller),
                      ),
                      const SizedBox(width: 8),
                      _buildCircleAction(
 ...
 void _showEditTrainerUI(BuildContext context, TrainerModel trainer , TrainersController controller) {
    showTrainerForm(context, trainer, controller);
  }


  
  void _showDeleteConfirmation(TrainerModel trainer , TrainersController controller) {
    Get.dialog(
      AlertDialog(
