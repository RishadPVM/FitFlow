    ...
    return Row(
      children: [
        ...
        _buildPremiumDropdown(
          ...
          value: controller.specializationFilter.value,
          items: ['All', 'Strength', 'Cardio', 'Yoga', 'CrossFit', 'General Fitness'],
          onChanged: (val) => controller.specializationFilter.value = val!,
        ),
        if (controller.searchQuery.value.isNotEmpty || controller.statusFilter.value != 'All' || controller.specializationFilter.value != 'All')
          IconButton(
            onPressed: () {
              controller.searchQuery.value = '';
              controller.statusFilter.value = 'All';
              controller.specializationFilter.value = 'All';
            },
